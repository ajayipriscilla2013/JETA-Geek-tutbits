                ...
                <div class="col-lg-6 equal-height">
                    <div class="half_column_content">
                        ...
                        <div class="theme-list ml-xl-5">
                            <ul>
                                <li><a href="#">Great Technology</a></li>
                                <li><a href="#">Academic Status Assessment</a></li>
                                <li><a href="#">Parent/Guardian Involvement</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-sm-6 col-12" data-aos="fade-in" data-aos-delay="200">
                        <div class="single-service default_bg text-center text-white py-5 px-4">
                            ...
                            <div class="service-text">
                                ...
                                <p>Our team of experienced tutors is available to answer your questions and provide
                    ...
                    <div class="col-xl-4 col-sm-6 col-12" data-aos="fade-in" data-aos-delay="400">
                        <div class="single-service hover_bg text-center text-white py-5 px-4">
                            ...
                            <div class="service-text">
                                ...
                                <p>We help our students plan ahead to ensure they're prepared for every class, test, and
                    ...
                    <div class="col-xl-4 col-sm-6 col-12" data-aos="fade-in" data-aos-delay="600">
                        <div class="single-service default_bg text-center text-white py-5 px-4">
                            ...
                            <div class="service-text">
                                ...
                                <p>Our progress tracking tools help you visualize your growth. By identifying trends in
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 py-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="single-item">
                        ...
                        <div class="item-text">
                            <h4><a href="#">Academic Status Assessment</a></h4>
                            <p>From the moment you subscribe, we assess your academic status and history to understand
                ...
                <div class="col-lg-4 col-md-6 py-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="single-item">
                        ...
                        <div class="item-text">
                            <h4><a href="#">Parent/Guardian Involvement</a></h4>
                            <p>We believe in keeping your support system informed. Regular progress updates are shared
                ...
                <div class="col-lg-4 col-md-6 py-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="single-item">
                        ...
                        <div class="item-text">
                            <h4><a href="#">Streamlined Academic Journey</a></h4>
                            <p>With access to your course registration and school calendar, we manage and prioritize key
                                academic milestones. This way, you can stay prepared and avoid last-minute stress before
                                exams and tests.
                            </p>
                            <!-- <a href="#" class="link_btn mt-2">Read More <i class="fa fa-angle-right"></i> </a> -->
                        </div>
                ...
                <div class="col-lg-4 col-md-6 py-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="single-item">
                        ...
                        <div class="item-text">
                            <h4><a href="#">Course Compact Assistance</a></h4>
                            <p>We use your course compacts to align our tutoring and mentoring efforts with your course
                                objectives. By following the specific guidelines of your registered courses, we ensure
                                all assistance we provide is relevant to your academic needs.
                            </p>
                            <!-- <a href="#" class="link_btn mt-2">Read More <i class="fa fa-angle-right"></i> </a> -->
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 py-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="single-item">
                        ...
                        <div class="item-text">
                            <h4><a href="#">Dedicated Course Mentoring</a></h4>
                            <p>We break down complex course material into manageable learning goals, helping you better
                                understand course content, improve your grades, and stay ahead in your studies.
                            </p>
                            <!-- <a href="#" class="link_btn mt-2">Read More <i class="fa fa-angle-right"></i> </a> -->
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-3d-5" data-aos="fade-in-left" data-aos-delay="200">
                        <div class="half_column_image overlay">
                            ...
                            <!-- <div class="video-play-btn"><a data-fancybox
                                    href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="video-play-link"><i
                                        class="fas fa-play-circle"></i></a></div>  -->
                        </div>
                    </div>
                        ...
                        <div class="our-team-carousel owl-carousel">
                            <div class="single-team">
                                <div class="member-image">
                                    <img src="assets/images/member_01.jpg" alt="team member" class="img-fluid">
                            ...
                            <div class="single-team">
                                <div class="member-image">
                                    <img src="assets/images/member_02.jpg" alt="team member" class="img-fluid">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                            ...
                            <div class="single-team">
                                <div class="member-image">
                                    <img src="assets/images/member_03.jpg" alt="team member" class="img-fluid">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col-md-12">
                        <div class="testimonials-wrapper owl-carousel">
                            <div class="single-testimonial border-2 p-4">
                                <p>Tutbits transformed my academic experience. I was struggling with my programming
                                    course and was on the verge of failing. Thanks to the dedicated tutors at Tutbits, I
                                    was able to rewrite my exams with newfound confidence. Their continuous monitoring
                                    of my schoolwork kept me accountable, and I’ve never felt more prepared!</p>
                                <div class="testimonial-referance">
                                    <p><strong>Jon A; </strong> Computer Science</p>
                                </div>
                            </div>
                            <div class="single-testimonial border-2 p-4">
                                <p> "After failing some courses, I thought I might not graduate on time. Tutbits came to
                                ...
                                <div class="testimonial-referance">
                                    <p><strong>Sarah; </strong> Business Administration</p>
                                </div>
                            </div>
                            <div class="single-testimonial border-2 p-4">
                                <p>Tutbits helped me regain control over my studies. I felt overwhelmed with coursework,
                                    but their tutoring sessions provided clarity when I had to retake exams. Plus, their
                                    academic monitoring kept me organized and focused. I can honestly say I’m doing
                                    better now than I ever thought possible!"

                                </p>
                                <div class="testimonial-referance">
                                    <p><strong> Smith; </strong>Civil Engineering</p>
                                </div>
                            </div>
                            <div class="single-testimonial border-2 p-4">
                                <p>I can’t thank Tutbits enough for their help. I struggled with some challenging
                                    courses and needed to retake exams. The tutors were incredibly supportive, breaking
                                    down complex topics. Their monitoring of my schoolwork motivated me to stay
                                    disciplined, and my grades have improved significantly!.</p>
                                <div class="testimonial-referance">
                                    <p><strong>Grace; </strong> Mass Communication</p>
                                </div>
                            </div>
                            <!-- <div class="single-testimonial border-2 p-4">
                    ...
                    <div class="col-lg-6 mb-3d-5" data-aos="fade-up" data-aos-delay="200">
                        <div class="big-blog-area border bg-white">
                            <div class="blog-thumb">
                                <a href="#"><img src="assets/images/big_blog.jpg" alt="big blog" class="img-fluid"></a>
                            </div>
                            <div class="blog-content p-4">
                                <div class="blog-meta">
                                    <span>Posts By <a href="#">Admin</a></span> <span class="seperator">|</span>
                                    <span>29 April, 2020</span>
                                </div>
                                <div class="blog-text">
                                    <h3><a href="#">Most unusual uses of artificial intelli gence projects.</a></h3>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="blog-lists-wrapper">
                            <div class="single-blog-wrapper">
                                <div class="blog-thumb pe-4">
                                    <a href="#"><img src="assets/images/blog_01.jpg" alt="blog"></a>
                                </div>
                                <div class="blog-content-wrapper">
                                    <h4><a href="#">Most unusual uses of artificial intelli gence projects.</a></h4>
                                    <p>Lorem ipsum dolor sit amet, cteturadipiscing elit, sed do eiusmod tempor. ipsum
                                        dolor.</p>
                            ...
                            <div class="single-blog-wrapper">
                                <div class="blog-thumb pe-4">
                                    <a href="#"><img src="assets/images/blog_02.jpg" alt="blog"></a>
                                </div>
                                <div class="blog-content-wrapper">
                                    <h4><a href="#">Most unusual uses of artificial intelli gence projects.</a></h4>
                                    <p>Lorem ipsum dolor sit amet, cteturadipiscing elit, sed do eiusmod tempor. ipsum
                            ...
                            <div class="single-blog-wrapper">
                                <div class="blog-thumb pe-4">
                                    <a href="#"><img src="assets/images/blog_03.jpg" alt="blog"></a>
                                </div>
                                <div class="blog-content-wrapper">
                                    <h4><a href="#">Most unusual uses of artificial intelli gence projects.</a></h4>
                                    <p>Lorem ipsum dolor sit amet, cteturadipiscing elit, sed do eiusmod tempor. ipsum
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="footer-bottom">
                        ...
                        <div class="logo-ft">
                            <div><a href=""><img src="./assets/img/geekcircleslogo.jpg" alt="logo" width="100px" height="100px"></a>
                            </div>
