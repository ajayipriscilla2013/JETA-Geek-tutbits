                    ...
                    <div class="col-md-12 mx-auto text-center mb-5">
                        <div class="portfolios-list-2">
                            <ul>
                                ...
                                <li class="button_four filter-button" data-filter="branding">Branding</li>
                                <li class="button_four filter-button" data-filter="design">Web Design</li>
                                <li class="button_four filter-button" data-filter="ui_design">UI Design</li>
                                <li class="button_four filter-button" data-filter="business">Business</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-sm-6 filter ui_design p-0 m-0">
                        <div class="single-gallery">
                            <div class="gallery-image">
                                <img src="assets/img/pic16.jpg" alt="Featured" class="img-fluid">
                    ...
                    <div class="col-lg-4 col-sm-6 filter business p-0 m-0">
                        <div class="single-gallery">
                            <div class="gallery-image">
                                <img src="assets/img/pic17.jpg" alt="Featured" class="img-fluid">
                                <div class="gallery-content">
                    ...
                    <div class="col-lg-4 col-sm-6 filter design branding  p-0 m-0">
                        <div class="single-gallery">
                            <div class="gallery-image">
                                <img src="assets/img/pic20.jpg" alt="Featured" class="img-fluid">
                                <div class="gallery-content">
                                        <h3>Branding And Promotion</h3>
                                        <div class="gallery-links">
                                            <ul>
                                                <li><a href="#"><i class="fas fa-search"></i></a></li>
                                                <li><a href="#"><i class="fas fa-link"></i></a></li>
                    ...
                    <div class="col-lg-4 col-sm-6 filter branding  p-0 m-0">
                        <div class="single-gallery">
                            <div class="gallery-image">
                                <img src="assets/img/pic13.jpg" alt="Featured" class="img-fluid">
                                <div class="gallery-content">
                                        <h3>Branding Your Products</h3>
                                        <div class="gallery-links">
                                            <ul>
                                                <li><a href="#"><i class="fas fa-search"></i></a></li>
                                                <li><a href="#"><i class="fas fa-link"></i></a></li>
                    ...
                    <div class="col-lg-4 col-sm-6 filter design  p-0 m-0">
                        <div class="single-gallery">
                            <div class="gallery-image">
                                <img src="assets/img/pic15.jpg" alt="Featured" class="img-fluid">
                                <div class="gallery-content">
                    ...
                    <div class="col-lg-4 col-sm-6 filter business  p-0 m-0">
                        <div class="single-gallery">
                            <div class="gallery-image">
                                <img src="assets/img/pic19.jpg" alt="Featured" class="img-fluid">
                                <div class="gallery-content">
                                        <h3>Frowing Business</h3>
                                        <div class="gallery-links">
                                            <ul>
                                                <li><a href="#"><i class="fas fa-search"></i></a></li>
                                                <li><a href="#"><i class="fas fa-link"></i></a></li>
